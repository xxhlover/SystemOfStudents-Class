        ...
        <div class="widget-content nopadding">
          <form action="#" method="get" class="form-horizontal" id="updateform">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" name="sno" id="sno" value="<?=$student['sno'];?>" class="span11" placeholder="学号" />
                <span class="err"></span>
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" name="mobile" id="mobile" value="<?=$student['mobile'];?>" class="span11" placeholder="手机号" />
                <span class="err"></span>
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" name="idcount" id="idcount" value="<?=$student['idcount'];?>" class="span11" placeholder="身份证号" />
                <span class="err"></span>
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" name="address" id="address" value="<?=$student['address'];?>" class="span11" placeholder="地址" />
                <span class="err"></span>
              </div>
            </div>
